...
\begin{rSubsection}{Mphasis Limited}{Nov 2015-Present}{Senior Software Engineer}{Houston/Bangalore}    
...
{\textbf{Development Languages:} Python, C, Golang, Shell Scripting, SQL }  \\
...
\item Implemented RESTful and Private API for UI with REDFISH standard
...
{HPE Houston}{Environment: Ubuntu, Django,  SQLite, ZeroMQ, Python, C, Golang, Pyinstaller}{ }  %June 2016 - November 2016
...
\item Improved API latency by 75\%, by completely rewriting blade cache with reduced number of HTTP request
...
\item Involved in developing CLI, Redfish REST apis and other backend logics
...
\item \textbf{Master Go (Golang) Programming} from \textbf{Andrei Dumitrescu, Udemy}
