...
%--------------------------------------------------------------------------------------------------
% broker for enterprise notification
% OneView-CISCO ACI integration
% SCE/vSCE
%--------------------------------------------------------------------------------------------------
...
\item Implemented REST API and a plugin which interact with OneView's REST and RabbitMQ
...
%--------------------------------------------------------------------------------------------------
\begin{rSubsection}{OneView-CISCO ACI integration}
{HPE Bangalore}{Environment: CentOS, Docker, Django,  SQLite, AMQP}{ }  %June 2016 - November 2016
